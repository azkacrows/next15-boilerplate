...
test.describe('Navigation', () => {
    test('should navigate to Getting Started page', async ({ page }) => {
        ...
        await expect(page.getByRole('heading', { name: /Getting Started with Next.js 15/i })).toBeVisible();
    });
    ...
    test('should navigate to Learn More page', async ({ page }) => {
        ...
        await expect(page.getByRole('heading', { name: /Learn More About This Boilerplate/i })).toBeVisible();
    });
    ...
    test('should navigate to Routing Guide page', async ({ page }) => {
        ...
        await expect(page.getByRole('heading', { name: /Routing Guide for Next.js 15/i })).toBeVisible();
    });
    ...
    test('should navigate between pages using header logo', async ({ page }) => {
        ...
        await page.click('h1:has-text("Next.js 15 Boilerplate")');
        await expect(page).toHaveURL('/en');
    });
    ...
    test('should have working cross-links between all pages', async ({ page }) => {
        ...
        // Go to Learn More from Getting Started
        ...
        // Go to Getting Started from Routing Guide
