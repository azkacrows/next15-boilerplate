          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="border border-border rounded-lg p-6">
                  <h3 className="font-semibold text-foreground mb-2">Tailwind CSS 4</h3>
                  <p className="text-sm text-muted-foreground">
                    {t("learnMore.technologies.tailwind")}
                  </p>
                </div>
                <div className="border border-border rounded-lg p-6">
                  <h3 className="font-semibold text-foreground mb-2">next-intl</h3>
                  <p className="text-sm text-muted-foreground">
            ...
            <section>
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                <ul className="space-y-3">
                  ...
                  <li>
                    <a href="https://next-intl-docs.vercel.app/" target="_blank" rel="noopener noreferrer"
                       className="text-primary hover:underline">
